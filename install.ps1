...
workflow-kit: hooks are installed but NOT yet wired up.
  ...
  Hooks that will run once enabled (require a bash runtime, e.g. Git Bash):
    ...
    - statusLine       -> hooks/caveman-statusline.ps1  ([CAVEMAN] badge while active; .sh on Unix)
  ...
  still load on demand. On Windows, point statusLine at caveman-statusline.ps1.
